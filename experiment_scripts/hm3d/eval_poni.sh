...
MODEL_PATH="../pretrained_models/hm3d_models/poni_seed_123.ckpt"
...
for part_id in 0 1 2 3 4 5; do
    ...
    --exp-config transfer_configs/transfer_objectnav_hm3d.yaml \
    TASK_CONFIG.DATASET.DATA_PATH "../data/datasets/objectnav/hm3d/v1/val_parts/{split}/{split}.json.gz" \
    EVAL.SPLIT $val_part \
